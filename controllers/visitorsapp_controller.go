...
import (
	...
	examplev1 "github.com/coriaedu/visitor-operator/api/v1"
)
...
//+kubebuilder:rbac:groups=example.my.domain,resources=visitorsapps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=example.my.domain,resources=visitorsapps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=example.my.domain,resources=visitorsapps/finalizers,verbs=update
